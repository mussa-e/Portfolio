 ...
 * @function
 * @param {string} lang - Language code to apply (e.g. "en" or "de")
 * @returns {void}
 */
...
/**
 * Translates a single element based on its translation key.
 * @function
 * @param {HTMLElement} element - Element containing the translation key
 * @param {string} lang - Language code used for translation lookup
 * @returns {void}
 */
...
/**
 * Applies the translated content to the specified element.
 * Handles plain text, HTML content, and special translation cases.
 * @function
 * @param {HTMLElement} element - Element to update
 * @param {string} key - Translation key of the element
 * @param {string} translation - Translated text or HTML content
 * @returns {void}
 */
...
/**
 * Checks whether a translation key contains HTML content.
 * @function
 * @param {string} key - Translation key to evaluate
 * @returns {boolean} True if the translation should be rendered as HTML, otherwise false
 */
